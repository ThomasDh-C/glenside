...
pub fn relu_on_nvdla() -> RW {
    rewrite!("relu-on-nvdla";
            ...
            =>
            "(accelerator-call nvdla-layerrelu ?data (shape 0))")
}
...
pub fn biasadd_on_nvdla() -> RW {
    rewrite!("biasadd-on-nvdla";
            ...
            =>
            "(accelerator-call nvdla-channelbiasadd ?data ?bias ?axis (shape 0))")
}
...
pub fn elemwisemax_on_nvdla() -> RW {
    rewrite!("elemwisemax-on-nvdla";
            ...
            =>
            "(accelerator-call nvdla-elemwisemax ?lhs ?rhs (shape 0))")
}
...
pub fn elemwisemin_on_nvdla() -> RW {
    rewrite!("elemwisemin-on-nvdla";
            ...
            =>
            "(accelerator-call nvdla-elemwisemin ?lhs ?rhs (shape 0))")
}
...
pub fn elemwiseequal_on_nvdla() -> RW {
    rewrite!("elemwiseequal-on-nvdla";
            ...
            =>
            "(accelerator-call nvdla-elemwiseequal ?lhs ?rhs (shape 0))")
}
...
pub fn prelu_on_nvdla() -> RW {
    rewrite!("prelu-on-nvdla";
            ...
            =>
            "(accelerator-call nvdla-channelprelu ?data ?alpha ?axis (shape 0))")
}
...
pub fn maxpool2d_on_nvdla() -> RW {
    rewrite!("avgpool2d-on-nvdla";
            ...
            =>
            "(accelerator-call nvdla-maxpool2d ?data ?pool_size ?strides ?dilation ?padding ?layout ?out_layout ?ceil_mode ?count_include_pad (shape 0))")
}
